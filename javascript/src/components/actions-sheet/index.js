...
import { ActionSheetIOS, Modal, Platform, ScrollView, View } from 'react-native';
...
import { hpx } from '../../utils/ScreenUtil';
...
class ActionSheetAndroid extends Component {
  ...
  _closeModal = index => {
    ...
    this.handleRef.fadeOut(200).then(() => topView.remove('ActionSheet'));
    ...
    return (
      <View style={{ zIndex: 1000 }}>
        <Modal
          visible={true}
          transparent={true}
          onRequestClose={() => topView.remove('ActionSheet')}
        >
          <Animatable.View
