...
export default (options = {}) => WrappedComponent => {
    ...
    componentDidDisappear() {
      const componentDidDisappearFunc = WrappedComponent.prototype.componentDidDisappear;
      componentDidDisappearFunc && componentDidDisappearFunc();
		}

    onComponentResult(requestCode, resultCode, data) {
      const onComponentResultFunc = WrappedComponent.prototype.onComponentResult;
      onComponentResultFunc && onComponentResultFunc(requestCode, resultCode, data)
    }
